...
const forecastingLabels = [
  ...
  "Detecting the flake",
  "Monitoring the incoming excuse-front",
  ...
  "Observing the flake-dar",
  "Scanning for incoming radio silence",
  "Forecasting the social fallout",
  "Detecting the social cold front",
  "Tracking the migration of the hermit",
  "Pinpointing the social epicenter",
  "Reading the social altimeter",
  "Calibrating the flakiness sensors",
  ...
  "Assessing the 'going out stress' test",
  "Factoring in the comfort-zone climate",
  "Checking the commitment compass",
  "Measuring the density of the excuse",
  "Forecasting the unforeseen events",
  "Gauging the social sunlight",
  "Tracking the 'I'll try' excuses",
  ...
  "Reading the stars for flake prediction",
